...
const UploadZone = ({ onFileSelect }) => {
  ...
  return !file ? (
    <div onClick={()=>ref.current.click()} className="border-2 border-dashed border-black/15 rounded-2xl p-10 text-center cursor-pointer hover:border-primary/40 hover:bg-surface transition-all">
      ...
      <p className="text-textMain text-sm font-medium">Drop file or click to upload</p>
    </div>
  ) : (
